namespace Ordering.Infrastructure.Extensions
{
    internal class InitialData
    {
        public static IEnumerable<Customer> Customers =>
            new List<Customer>
            {
                Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "chula", "chula@gmail.com"),
        ...
        public static IEnumerable<Order> OrdersWithItems
        {
            get
            {
                var address1 = Address.Of("chula", "fernando", "chula@gmail.com", "Flesastunet 8", "Norway", "Oslo", "0860");
                var address2 = Address.Of("john", "doe", "john@gmail.com", "Broadway No:1", "England", "Nottingham", "08050");

                var payment1 = Payment.Of("chula", "5555555555554444", "12/28", "355", 1);
